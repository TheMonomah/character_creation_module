...
def attack(char_name: str, char_class: str) -> str:
    """Вычесляет наносимый урон, в зависимости от выбранного класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычесляет блокируеммый урон, в зависимости от выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет нужное специальное умение.
...
def start_training(char_name: str, char_class: str) -> str:
    """Проводит тренировку в соответствии.
    С заданными пользователем коммандами.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Запрашивает у пользователя "Имя" и "Класс"."""
